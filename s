...
local function ChangeToggleColor(Button)
	...
	if led.ImageColor3 == Color3.fromRGB(129, 129, 129) then
...
Background.BorderColor3 = Color3.fromRGB(129, 129, 129)
...
TitleBarLabel.Text = "____/Avtor Scripts\\___"
TitleBarLabel.TextColor3 = Color3.fromRGB(129, 129, 129)
...
SendNotify("System Broken","кастом сустем брокен от Avtor Scripts",10)
